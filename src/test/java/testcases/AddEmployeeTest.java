...
public class AddEmployeeTest extends CommonMethods {
    ...
    //simdi burada baska bir test case yaziyoruz dedi.
    @Test
...
//navigate to add employee page
        ...
        while (it.hasNext()) {
            ...
            click(addEmployeePage.saveBtn);
//CUMARTESI DERSINIZ IZLEYINCE BURADAN DEVAM EDECEGIM. SU ANA KADAR TESTLER GECTI.
            //navigate to employee list page
            //BURADA ID DEN YOLA CIKARAK TEST YAPIYOR.
            click(dashBoardPage.pimOption);
